...
/***/ function(module, exports, __webpack_require__) {
	...
	var _totalCount = __webpack_require__(167);

	var _totalCount2 = _interopRequireDefault(_totalCount);
	...
	var App = function (_React$Component2) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function incrementCounter(counterIndex) {
	    ...
	    value: function render() {
	      ...
	      var counters = this.state.counters.map(function (count, index) {
	        return _react2.default.createElement(_counter2.default, {
	          key: index,
	          handleIncrement: _this3.incrementCounter.bind(_this3, index),
	          count: count });
	      });

	      var nameArr = ['Jacob', 'Jordan', 'John', 'Jim'];
	      var allGreetings = nameArr.map(function (item) {
	        return _react2.default.createElement(Greeting, { name: item });
	      });
	      ...
	      */
	      ...
	      var totalCount = 0;
	      this.state.counters.forEach(function (count) {
	      ...
	      return _react2.default.createElement(
	        ...
	        allGreetings,
	        counters,
	        _react2.default.createElement(_totalCount2.default, { totalCount: totalCount })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TotalCount = function (_Component) {
	  _inherits(TotalCount, _Component);

	  function TotalCount() {
	    _classCallCheck(this, TotalCount);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TotalCount).apply(this, arguments));
	  }
